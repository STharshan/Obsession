...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I can’t praise Chris the owner of Obsessions Detailing enough. He’s very hard working and his obsession for detail is paramount. He made my already smart 18 year old Jaguar Sovereign look like she’d come straight out the showroom. Well done Chris, I’m chuffed to bits with my Jaaaag. Definitely a 5 star ⭐️⭐️⭐️⭐️⭐️ rating for me.",
    name: "Gary Baker",
  },
