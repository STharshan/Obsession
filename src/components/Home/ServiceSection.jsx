...
​`,
  ...
  },
  {
    ...
    desc: `A clear, durable film applied to your vehicle’s paintwork to protect against stone chips, scratches, and road debris while keeping the original finish looking new.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[63%] mt-20 mx-auto h-28 object-cover"
                    onError={(e) => {
